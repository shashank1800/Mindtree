...
public class TestUSN {
	 ...
	 * 
	 * 2) Loop through USN check if position was suppose to 
	 * be char or digit
	 * 	  if character check whether it is upper case letter
	 * 	  if digit check it is position 0 and it's 1 or 2.
	 * 
	 * 3) If position is 5th then take 2 letters and check 
	 * it's valid branch name.
	 * 
	 * 4) If any of the above condition fails then return false
	 * otherwise true.
	 * 
	 */
